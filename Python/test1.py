...
#massive = 'маша маша леша кошка суп картошка блоша пирог чипсики чипсики маша леша чипсики шерсть нитки иголки чипсики чипсики чипсики нитки'
massive = input()
...
most_common_word = min(word for word, count in x.items()
